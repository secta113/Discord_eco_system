...
def test_anti_taboo_combat_bonus():
    ...
    me = Dobumon(dobumon_id="me", owner_id=1, name="Hunter", gender="M", hp=100, atk=10, defense=10, eva=10, spd=10)
    
    # 相手が禁断の場合
    opponent_forbidden = Dobumon(dobumon_id="op1", owner_id=1, name="TheOne", gender="M", hp=100, atk=10, defense=10, eva=10, spd=10)
    ...
    # 相手が禁忌深度を持つ場合
    opponent_depth = Dobumon(dobumon_id="op2", owner_id=1, name="Deep", gender="M", hp=100, atk=10, defense=10, eva=10, spd=10)
...
def test_forbidden_blue_consumption():
    """青の禁忌による寿命消費倍率を検証"""
    dobu = Dobumon(dobumon_id="blue", owner_id=1, name="Blue", gender="F", hp=100, atk=10, defense=10, eva=10, spd=10)
